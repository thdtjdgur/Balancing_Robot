...
// [HILS 전용] 매트랩 수신 데이터 공유 변수
extern float hils_angle_l;
extern float hils_angle_r;
extern float hils_pitch;
extern float hils_yaw;

// [HILS 전용] 매트랩 응답 송신 데이터 버퍼 (Call-and-Response 싱크용)
extern float hils_v_out[6];